...
if (form) {
  form.addEventListener("submit", (e) => {
    ...
    // Send form data to yourself (optional)
    emailjs.send("service_yusnw04", "template_t55fvzr", formData)
      .then(() => {
        ...
        // Send automatic response email to user
        const autoResponse = {
          to_email: formData.from_email,
          from_name: "Sakshi Donk",
          message: `Hello ${formData.from_name},\n\nThank you for contacting me! I have received your message and will get back to you shortly.\n\nBest regards,\nSakshi`
        };

        emailjs.send("service_yusnw04", "template_auto_response", autoResponse)
          .then(() => console.log("Auto-response email sent to user"))
